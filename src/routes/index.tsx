        ...
        <div className="mx-auto grid max-w-6xl items-center gap-16 px-6 md:grid-cols-[1.05fr_1fr] md:px-8">
          ...
          <Reveal delay={150}>
            <div className="grid grid-cols-2 gap-3">
              <Link
                to="/games"
                className="card-line group relative col-span-2 block overflow-hidden border border-border/50"
              >
              ...
              {[shot2, shot3].map((src, i) => (
                <Link
                  key={i}
                  to="/games"
                  className="card-line group relative block overflow-hidden border border-border/50"
                >
